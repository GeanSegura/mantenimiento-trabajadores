...
-- Description: script backup db
-- =============================================
*/

-- verificar si existe la db TrabajadoresPrueba
IF EXISTS (SELECT *
FROM sys.sysdatabases
WHERE [name]  = 'TrabajadoresPrueba')
	BEGIN
		DROP DATABASE TrabajadoresPrueba
	END
GO

-- crear la db TrabajadoresPrueba

CREATE DATABASE TrabajadoresPrueba

GO

-- usar la db TrabajadoresPrueba
